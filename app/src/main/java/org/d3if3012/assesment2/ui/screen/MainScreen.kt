...
import org.d3if3012.assesment2.navigation.Screen
import org.d3if3012.assesment2.ui.theme.Assesment2Theme
import org.d3if3012.assesment2.util.SettingsDataStore
...
@Composable
fun ListItem(barangs: Barang, onClick: () -> Unit){
    Column (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
        ...
        Text(text = barangs.jenis)
    }
}

@Composable
fun GridItem(barangs: Barang, onClick: () -> Unit) {
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
